...
class Cube: GLSurfaceView.Renderer {
    ...
    private val colors: FloatArray = floatArrayOf(
        1.0f, 0.0f, 0.0f, 1.0f,  // Red (R, G, B, A) - Front face
        0.0f, 1.0f, 0.0f, 1.0f,  // Green - Back face
        0.0f, 0.0f, 1.0f, 1.0f,  // Blue - Top face
        1.0f, 1.0f, 0.0f, 1.0f,  // Yellow - Bottom face
        1.0f, 0.0f, 1.0f, 1.0f,  // Magenta - Right face
        0.0f, 1.0f, 1.0f, 1.0f   // Cyan - Left face
    )
